...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    print('\nCNN model used: {}'.format(model))
    
    print('Number of images: {} | Number of Dog Images: {} | Number of Not-a-Dog Images: {}'\
          .format(results_stats_dic['n_images'], results_stats_dic['n_dogs_img'],\
                  results_stats_dic['n_notdogs_img']))
    
    print('% Correct Dogs: {:5.1f} | % Correct Breeds: {:5.1f} | % Correct Not-a-Dogs: {:5.1f} | % Match: {:5.1f}'\
